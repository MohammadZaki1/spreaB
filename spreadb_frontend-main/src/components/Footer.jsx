    ...
    <footer className="bg-black text-white px-6 md:px-16 lg:px-24 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            <li><Link to="/find-work" className="hover:text-white">How to find Promotions</Link></li>
            <li><Link to="/jobs/worldwide" className="hover:text-white">Find freelance jobs worldwide</Link></li>
            <li><Link to="/jobs/usa" className="hover:text-white">Find Promoations INdia</Link></li>
